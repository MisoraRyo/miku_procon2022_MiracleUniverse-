...
void main(){
  ...
  //float elevationY =  abs ( sin(modelPostion.x) * cos(modelPostion.z) ) ;
  modelPostion.x += distortion.x;
  modelPostion.y += distortion.y - speed * uTime;
  modelPostion.z += distortion.z;
